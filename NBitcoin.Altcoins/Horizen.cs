...
{
    // Reference: https://github.com/z-classic/Horizen/blob/master/src/chainparams.cpp
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        protected override NetworkBuilder CreateMainnet()
        {
            ...
            .AddDNSSeeds(new[]
            {
                ...
                new DNSSeedData("mainnet.zensystem.io", "mainnet.zensystem.io"),
        ...
        protected override NetworkBuilder CreateTestnet()
        {
            ...
            .SetBase58Bytes(Base58Type.PUBKEY_ADDRESS, new byte[] { 0x20, 0x98 })
            .SetBase58Bytes(Base58Type.SCRIPT_ADDRESS, new byte[] { 0x20, 0x92 })
            ...
            .AddDNSSeeds(new[]
            {
                new DNSSeedData("dnsseed.testnet.horizen.global", "dnsseed.testnet.horizen.global"),
                new DNSSeedData("dnsseed.testnet.zensystem.io", "dnsseed.testnet.zensystem.io"),
                new DNSSeedData("testnet.horizen.global", "testnet.horizen.global"),
                new DNSSeedData("testnet.zensystem.io", "testnet.zensystem.io"),
                new DNSSeedData("node1.zenchain.info", "node1.zenchain.info")
            })
            .AddSeeds(new NetworkAddress[0])
