...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        protected override NetworkBuilder CreateMainnet()
        {
            ...
            .AddDNSSeeds(new[]
            {
				new DNSSeedData("Horizen.org", "na1.Horizen.org"),
				new DNSSeedData("Horizen.org", "na2.Horizen.org"),
				new DNSSeedData("Horizen.org", "na3.Horizen.org"),
				new DNSSeedData("Horizen.org", "eu1.Horizen.org"),
				new DNSSeedData("Horizen.org", "eu2.Horizen.org"),
				new DNSSeedData("Horizen.org", "eu3.Horizen.org"),
				new DNSSeedData("Horizen.org", "as1.Horizen.org"),
				new DNSSeedData("Horizen.org", "as2.Horizen.org"),
				new DNSSeedData("Horizen.org", "as3.Horizen.org"),
